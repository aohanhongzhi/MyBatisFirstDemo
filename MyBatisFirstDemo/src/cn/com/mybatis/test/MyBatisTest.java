...
public class MyBatisTest {
	...
	//	DataConnection dataConn=new DataConnection();
		...
		SqlSession sqlSession=dataConn.getSqlSession();   
		User user=new User();
		user.setUsername("孙佳乐");
		user.setGender("女");
		user.setPassword("5222555");
		user.setEmail("2222222@126.com");
		SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
		user.setBirthday(sdf.parse("1994-02-16"));
		user.setProvince("湖北省");
		user.setCity(" 荆门市");
		//调用UserMapper.xml中的test.insertUser，sql语句
